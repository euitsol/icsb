...
class AdmissionCornerPagesController extends Controller
{public function __construct() {
    ...
    {
        $s['details'] = AdmissionCorner::where('deleted_at',null)->where('status',1)->orderBy('order_key','ASC')->get();
        $s['page_image'] = AdmissionCornerImage::where('deleted_at',null)->first();
        return view('frontend.admission_corners.details',$s);
    }
}
