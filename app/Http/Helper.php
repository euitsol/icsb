...
{
  return ['about.faq.','service.','contact.','national_connection.','wwcs.','event.','national_award.', 'blog.', 'settings.','banner.', 'member.','icsb_profile.','committee.','president.','sec_and_ceo.','job_placement.','cs_firm.','recent_video.','acts.'];
}
