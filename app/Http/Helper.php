...
{
  return ['about.faq.','service.','contact.','national_connection.','wwcs.','event.','national_award.', 'blog.', 'settings.','banner.', 'member.','icsb_profile.','committee.','president.','sec_and_ceo.','job_placement.','cs_firm.','recent_video.','acts.','exam_faq.','assined_officer.','sample_question_paper.'];
}
