...
@section('title', 'The Chartered Secretaries Act, 2010')
...
<section class="bredcum-section handbook-bredcum-section">
	<div class="container">
		<div class="bredcum-content text-align">
			<p><a href="{{route('home')}}">Home</a>| The Chartered Secretaries Act, 2010</p>
		</div>
	</div>
</section>
...
<section class="handbook-section section-padding">
	<div class="container">
		<div class="heading-content text-align">
			<h1 class="common-heading">The Chartered Secretaries Act, 2010</h1>
		</div>
