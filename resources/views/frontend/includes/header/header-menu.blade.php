                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="{{ route('council_view.past_presidents') }}">{{ _('Past Presidents') }}</a>
                                        </li>
                                ...
                                <li>
                                    <a class="main-nav" href="javascript:void(0)">Members <i class="fa-solid fa-angle-down icon"></i></a>
                                    <ul>
                                        ...
                                        <li><a class="sub-nav" href="#">Member’s Search <i
                                                    class="fa-solid fa-angle-down sub-icon"></i></a>
                                            <ul class="sub-menu">
                                                <li><a href="{{ route('member_view.m_search', 'honorary') }}">Honorary Members</a>
                                                </li>
                                ...
                                <li>
                                    <a class="main-nav" href="javascript:void(0)">Students <i class="fa-solid fa-angle-down icon"></i></a>
                                    <ul>
                                ...
                                <li>
                                    <a class="main-nav" href="javascript:void(0)">Employees <i class="fa-solid fa-angle-down icon"></i></a>
                                    <ul>
                                ...
                                <li>
                                    <a class="main-nav" href="javascript:void(0)">Rules <i class="fa-solid fa-angle-down icon"></i></a>
                                    <ul>
                                        @foreach ($menu_acts as $act)
                                            <li><a href="{{ route('rules_view.act.view', $act->slug) }}">{{ $act->title }}</a>
                                            </li>
                                        @endforeach
                                ...
                                <li>
                                    <a class="main-nav" href="javascript:void(0)">Publications<i class="fa-solid fa-angle-down icon"></i></a>
                                    <ul>
                                        <li><a
                                ...
                                <li>
                                    <a class="main-nav" href="javascript:void(0)">Examination <i class="fa-solid fa-angle-down icon"></i></a>
                                    <ul>
                                ...
                                <li>
                                    <a class="main-nav" href="javascript:void(0)">Media Room <i class="fa-solid fa-angle-down icon"></i></a>
                                ...
                                <li>
                                    <a class="main-nav" href="javascript:void(0)">Contact Us <i class="fa-solid fa-angle-down icon"></i></a>
                                    <ul>
                ...
                <ul>
                    ...
                    <li class="drop-down"><a href="javascript:void(0)">National Award for CG<i
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="{{ route('sp.frontend', 'jury-board') }}">{{ _('Jury Board') }}</a>
                            </li>
                            <li><a
                                    href="{{ route('sp.frontend', 'assessment-criteria') }}">{{ _('Assessment Criteria') }}</a>
                            </li>
                    ...
                    <li><a href="{{ route('sp.frontend', 'csr-initiatives') }}">{{ _('CSR Initiatives') }}</a>
                    </li>
                    <li><a href="{{ route('about.faq') }}">{{ _('FAQs') }}</a></li>
                </ul>
            </li>
