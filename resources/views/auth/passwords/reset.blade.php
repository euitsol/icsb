                                ...
                                <form class="form row g-4" method="post" action="{{ route('password.update') }}">
                                    @csrf
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-text" style="border-radius: 0.25rem 0 0 0.25rem;"><i class="fa-solid fa-envelope"></i></div>
                                                <input type="password" name="password" class="form-control {{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="Enter New Password" required>
                                            </div>
                                            @include('alerts.feedback', ['field' => 'email'])
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-text" style="border-radius: 0.25rem 0 0 0.25rem;"><i class="fa-solid fa-envelope"></i></div>
                                                <input type="password" name="password_confirmation" class="form-control {{ $errors->has('password_confirmation') ? ' is-invalid' : '' }}" placeholder="Confirm New Password" required>
                                            </div>
                                            @include('alerts.feedback', ['field' => 'password_confirmation'])
                                        </div>

                                        <div class="col-12">
                                            <button type="submit" class="btn btn-primary px-4 float-end mt-4 w-100">{{ _('Reset Password') }}</button>
                                        </div>
                                </form>
                            </div>
                        </div>
