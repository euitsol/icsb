...
@section('title', 'Edit Exam Frequently Asked Question')
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="title">{{ _('Edit Exam Frequently Asked Question') }}</h5>
                </div>
                <form method="POST" action="{{ route('exam_faq.exam_faq_edit', $faq->id) }}" autocomplete="off">
                    @method('PUT')
                    @csrf
                    <div class="card-body">
                        <div class="row">
