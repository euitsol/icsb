        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="title">{{ _('Add Sample Question Paper') }}</h5>
                </div>
                <form method="POST" action="{{ route('sample_question_paper.sqp_create') }}" autocomplete="off" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                            <div class="row">
