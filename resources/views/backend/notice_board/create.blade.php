                    ...
                    <div class="card-body">
                        ...
                        <div id="sms-details" class="mt-2" style="display: none;">
                            ...
                            <div class="form-group {{ $errors->has('sms_body') ? ' has-danger' : '' }}">
                                ...
                                <textarea rows="3" name="sms_body" class="w-100 {{ $errors->has('sms_body') ? ' is-invalid' : '' }} ck-off">{{ old('sms_body') }}</textarea>
            ...
            <div class="card card-user">
                <div class="card-body">
                    ...
                    <div class="card-description">
                        ...
                        <p><b>Notify All Members:</b> This is a checkbox. This checkbox determines whether to receive email notifications for this Notice.</p>
                    </div>
                </div>
            </div>
        </div>
