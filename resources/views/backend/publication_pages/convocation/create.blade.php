        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="title">{{ _('Add Convocation') }}</h5>
                </div>
                <form method="POST" action="{{ route('convocation.convocation_create') }}" autocomplete="off" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
