    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <form method="POST" action="{{ route('um.user.user_edit', $user->id) }}" autocomplete="off">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="card-body">
                        <div class="form-group {{ $errors->has('name') ? ' has-danger' : '' }}">
                            ...
                            <input type="text" name="name"
                                ...
                                placeholder="{{ _('Name') }}" value="{{ $user->name }}">
            ...
            <div class="card card-user">
                <div class="card-body">
                    ...
                    <div class="card-description">
                        ...
                        <p><b>Password:</b> This field is nullable and should be entered as a password. To ensure the
                        ...
                        <p><b>Confirm Password:</b> This field is required when you fill up the 'Password' field. It is a
                            password field. It should match the entered password in the 'Password' field.</p>
