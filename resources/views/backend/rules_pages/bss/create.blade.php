    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="title">{{ _('Add Bangladesh Secretarial Standards') }}</h5>
                </div>
                <form method="POST" action="{{ route('bss.bss_create') }}" autocomplete="off" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                            ...
                            <div class="form-group {{ $errors->has('short_title') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" name="short_title" class="form-control {{ $errors->has('short_title') ? ' is-invalid' : '' }}" placeholder="{{ _('short_Title') }}" value="{{ old('short_title') }}">
                            ...
                            <div class="form-group {{ $errors->has('image') ? ' has-danger' : '' }}">
                                ...
                                <input type="file" accept=".png" name="image" class="form-control image-upload  {{ $errors->has('image') ? ' is-invalid' : '' }}">
        ...
        <div class="col-md-4">
            <div class="card card-user">
                <div class="card-body">
                    <p class="card-text">
                        {{ _('Bangladesh Secretarial Standards') }}
                    </p>
