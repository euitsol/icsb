                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <form method="POST" action="{{ route('settings.site_settings') }}" autocomplete="off" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group{{ $errors->has('site_name') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="site_name"
                                            ...
                                            placeholder="{{ _('Site Name') }}" value="{{ $SiteSettings['site_name'] ?? '' }}">
                                    ...
                                    <div class="form-group{{ $errors->has('site_short_name') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="site_short_name"
                                            ...
                                            placeholder="{{ _('Site Name') }}" value="{{ $SiteSettings['site_short_name'] ?? '' }}">
                                    ...
                                    <div class="form-group{{ $errors->has('timezone') ? ' has-danger' : '' }}">
                                        ...
                                        <select name="timezone" class="form-control{{ $errors->has('timezone') ? ' is-invalid' : '' }}">
                                            @foreach ($availableTimezones as $at)
                                                <option value="{{ $at['timezone'] }}" @if(isset($SiteSettings['timezone']) && ($SiteSettings['timezone'] == $at['timezone'])) selected @endif> {{ $at['name'] ?? '' }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group{{ $errors->has('site_logo') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="file" name="site_logo" class="form-control image-upload {{ $errors->has('site_logo') ? ' is-invalid' : '' }}" @if(isset($SiteSettings['site_logo'])) data-existing-files="{{ storage_url($SiteSettings['site_logo']) }}" @endif accept="image/*">
                                    ...
                                    <div class="form-group{{ $errors->has('site_favicon') ? ' has-danger' : '' }}">
                                       ...
                                       <input type="file" name="site_favicon" class="form-control image-upload {{ $errors->has('site_favicon') ? ' is-invalid' : '' }}"  @if(isset($SiteSettings['site_favicon'])) data-existing-files="{{ storage_url($SiteSettings['site_favicon']) }}" @endif accept="image/*">
                                       @include('alerts.feedback', ['field' => 'site_favicon'])
                                    </div>

                                    <div class="form-group{{ $errors->has('env') ? ' has-danger' : '' }}">
                                        <label>{{ _('Environment') }} <small>({{ _('Best to keep in production') }})</small></label>
                                        <select name="env" class="form-control{{ $errors->has('env') ? ' is-invalid' : '' }}">
                                            <option value="production" @if(isset($SiteSettings['env']) && ($SiteSettings['env'] == 'production')) selected @endif>{{ _('Production') }}</option>
                                            <option value="local" @if(isset($SiteSettings['env']) && ($SiteSettings['env'] == 'local')) selected @endif>{{ _('Local') }}</option>
                                        </select>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group {{ $errors->has('mail_mailer') ? ' has-danger' : '' }}">
                                        ...
                                        <select name="mail_mailer" class="form-control  no-select  {{ $errors->has('mail_mailer') ? ' is-invalid' : '' }}">
                                            ...
                                            <option value="ses"      @if(isset($SiteSettings['mail_mailer']) && ($SiteSettings['mail_mailer'] == 'ses')) selected @endif>Amazon SES</option>
                                            <option value="postmark" @if(isset($SiteSettings['mail_mailer']) && ($SiteSettings['mail_mailer'] == 'postmark')) selected @endif>Postmark Mailer</option>
                                        </select>
                                    ...
                                    <div class="form-group {{ $errors->has('mail_username') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="mail_username"
                                            ...
                                            placeholder="{{ _('Username') }}" value="{{ $SiteSettings['mail_username'] ?? '' }}" autocomplete="off">
                                    ...
                                    <div class="form-group {{ $errors->has('mail_password') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="password" name="mail_password"
                                            ...
                                            placeholder="{{ _('Mail Password') }}" value="{{ $SiteSettings['mail_password'] ?? '' }}" autocomplete="off">
                                    ...
                                    <div class="form-group {{ $errors->has('mail_from_name') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="mail_from_name"
                                            ...
                                            placeholder="{{ _('Application Name') }}" value="{{ $SiteSettings['mail_from_name'] ?? '' }}">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group {{ $errors->has('database_driver') ? ' has-danger' : '' }}">
                                        ...
                                        <select name="database_driver" class="form-control  no-select {{ $errors->has('database_driver') ? ' is-invalid' : '' }}">
                                            ...
                                            <option value="sqlsrv"      @if(isset($SiteSettings['database_driver']) && ($SiteSettings['database_driver'] == 'sqlsrv')) selected @endif>SQL Server</option>
                                        </select>
                                    ...
                                    <div class="form-group {{ $errors->has('database_username') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="database_username"
                                            ...
                                            placeholder="{{ _('Database Username') }}" value="{{ $SiteSettings['database_username'] ?? '' }}" autocomplete="off">
                                    ...
                                    <div class="form-group {{ $errors->has('database_password') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="password" name="database_password"
                                            ...
                                            placeholder="{{ _('Database Password') }}" value="{{ $SiteSettings['database_password'] ?? '' }}" autocomplete="off">
