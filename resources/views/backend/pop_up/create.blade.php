        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="title">{{ _('Add Pop Up') }}</h5>
                </div>
                <form method="POST" action="{{ route('pop_up.pop_up_create') }}" autocomplete="off" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group {{ $errors->has('order_key') ? ' has-danger' : '' }}">
                                    ...
                                    <select class="form-control {{ $errors->has('order_key') ? ' is-invalid' : '' }}" name="order_key">
                                        ...
                                        @for ($x=1; $x<=100; $x++)
                                            @php
                                                $check = App\Models\PopUp::where('order_key',$x)->first();
                                            @endphp
                                            @if(!$check)
            ...
            <div class="card card-user">
                <div class="card-body">
                    ...
                    <div class="card-description">
                        <p><b>Image:</b> This field is required. It supports file uploads in jpeg, jpg, gif, & svg format, with a maximum size limit of 2MB. The dimensions of the image should be 1200 x 800x and it should have a white background.</p>
