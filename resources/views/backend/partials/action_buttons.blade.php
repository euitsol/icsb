<div class="dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
        ...
        @endphp
        @if ($check)
            <a class="dropdown-item @if(isset($menuItem['delete']) && $menuItem['delete'] == true) action-delete @endif" href="{{ route($menuItem['routeName'], $parameterArray) }}">{{ _($menuItem['label']) }}</a>
        @endif
